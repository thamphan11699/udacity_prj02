...
public final class CrawlerConfiguration {
   ...
   * setting is optional.
   *
   * <p>If set to 1, the legacy sequential crawler will be used (unless {@link
   * #getImplementationOverride()} explicitly specifies otherwise). If set to a value less than 1,
   * the crawler will default to using the number of available CPU cores on the system.
   */
   ...
   *
   * <p>If set, it should be the fully qualified class name of a {@link
   * com.udacity.webcrawler.WebCrawler} implementation, for example {@code
