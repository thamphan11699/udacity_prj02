...
final class WordCounts {
   ...
   * to the provided {@link WordCountComparator}, and includes only the top {@param
   * popluarWordCount} words and counts.
   *
   ...
   *
   * <ol>
   *   <li>First sorting by word count, ranking more frequent words higher.
   *   <li>Then sorting by word length, ranking longer words higher.
   *   <li>Finally, breaking ties using alphabetical order.
   * </ol>
   */
